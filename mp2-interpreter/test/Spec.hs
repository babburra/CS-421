...
testenv1 = H.fromList [("x", IntVal 3), ("y", BoolVal True), ("z", ExnVal "ZzZz"), ("f", CloVal [] (IntExp 0) H.empty)]
...
testclo1 :: Val
testclo1 = CloVal ["a"] (IntOpExp "*" (VarExp "a") (VarExp "x")) testenv1
testclo2 :: Val
testclo2 = CloVal ["y"] (BoolOpExp "and" (VarExp "y") (CompOpExp "==" (VarExp "x") (IntExp 3))) testenv1
testclo3 :: Val
testclo3 = CloVal ["x"] (IntOpExp "*" (VarExp "x") (VarExp "x")) testenv1
testclo4 :: Val
testclo4 = CloVal ["f", "x"] (IntOpExp "*" (VarExp "x") (AppExp (VarExp "f") [VarExp "x"])) testenv1

testenv2 :: HashMap [Char] Val
testenv2 = H.fromList [("f", testclo1), ("g", testclo2), ("h", testclo3), ("k", testclo4), ("x", ExnVal "Oops!")]
